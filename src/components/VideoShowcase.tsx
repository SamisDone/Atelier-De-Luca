...
const VideoShowcase = () => {
  ...
  return (
    <section id="videos" className="bg-background relative overflow-hidden h-[100svh] w-full flex-shrink-0 snap-start flex flex-col items-center justify-around pt-28 pb-12">
