...
const Services = () => {
	...
	return (
		<section
			id="services"
			className="relative w-full flex flex-col items-center justify-center pt-16 md:pt-20 bg-background snap-start"
		>
			<div className="container mx-auto px-6 h-full w-full flex flex-col justify-around pt-8 md:pt-12 pb-8 relative z-10">
				<motion.div
					...
					className="mb-8"
				>
					<p className="section-tagline">{messages.services.tagline}</p>
