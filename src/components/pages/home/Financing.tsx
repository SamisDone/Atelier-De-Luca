...
export default function Financing() {
	...
	const content = {
		en: {
			...
			description:
				"We offer tailored financing solutions to help you achieve the outdoor living space you've always wanted — without compromising on quality or design.",
			features: [
				{
				...
				},
				{
					...
					description:
						"Choose a payment plan that works perfectly for your budget.",
					icon: Clock,
				},
				{
					title: "Zero Hidden Fees",
					description:
						"Transparent pricing with clear, upfront terms from day one.",
					icon: CreditCard,
				},
			],
		...
		fr: {
			...
			description:
				"Nous offrons des solutions de financement sur mesure pour vous aider à obtenir l'espace extérieur que vous avez toujours voulu sans compromettre la qualité.",
			features: [
				{
					title: "Approbation Simple",
					description:
						"Processus de demande rapide et facile avec des décisions rapides.",
					icon: ShieldCheck,
				},
				{
				...
				},
				{
					...
					description:
						"Tarification transparente avec des conditions claires dès le premier jour.",
					icon: CreditCard,
				},
			],
	...
	return (
		<section
			ref={sectionRef}
			id="financing"
			className="relative w-full flex flex-col items-center justify-center overflow-hidden snap-start bg-brand-tertiary text-brand-secondary"
		>
			{/* Skewed top divider */}
			<div
			...
			<div className="container mx-auto px-6 relative z-10 w-full h-full flex flex-col justify-around pt-32 pb-28 md:pt-36 md:pb-32">
				<div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 w-full h-full">
					<div className="flex-1 space-y-6 md:space-y-8">
						...
						>
							<span className="section-tagline">{t.tagline}</span>
					...
					<motion.div
						className="flex-1 w-full grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 lg:gap-8"
						initial={{ scale: 0.5 }}
						animate={{ scale: 1 }}
					>
						{t.features.map((feature, index) => {
							...
							return (
								...
								>
									...
									<h3 className="font-serif text-xl md:text-2xl text-brand-secondary mb-3">
										{feature.title}
									</h3>
			...
			<div
				...
				style={{ clipPath: "polygon(0 98%, 179% 0, 100% 100%, 0 100%)" }}
			/>
		</section>
	);
}
